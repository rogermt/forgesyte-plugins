...
class TestTeamClassifierPrediction:
    ...
    def mock_classifier(self) -> TeamClassifier:
        ...
        with (
            ...
            classifier.cluster_model.predict = MagicMock(return_value=np.array([0, 1]))  # type: ignore[method-assign]
    ...
    def test_fit_predict_pipeline(self, mock_classifier: TeamClassifier) -> None:
        ...
        mock_classifier.extract_features = MagicMock(return_value=np.random.rand(2, 512))  # type: ignore[method-assign]
        mock_classifier.reducer.fit_transform = MagicMock(return_value=np.random.rand(2, 3))  # type: ignore[method-assign]
        mock_classifier.reducer.transform = MagicMock(return_value=np.random.rand(2, 3))  # type: ignore[method-assign]
    ...
    def test_predict_single_crop(self, mock_classifier: TeamClassifier) -> None:
        ...
        mock_classifier.extract_features = MagicMock(return_value=np.random.rand(1, 512))  # type: ignore[method-assign]
        mock_classifier.reducer.transform = MagicMock(return_value=np.random.rand(1, 3))  # type: ignore[method-assign]
    ...
    def test_predict_large_batch(self, mock_classifier: TeamClassifier) -> None:
        ...
        mock_classifier.extract_features = MagicMock(return_value=np.random.rand(10, 512))  # type: ignore[method-assign]
        mock_classifier.reducer.transform = MagicMock(return_value=np.random.rand(10, 3))  # type: ignore[method-assign]
...
class TestCreateBatches:
    ...
    def test_create_batches_empty_sequence(self) -> None:
        ...
        batches: list[list[int]] = list(create_batches([], batch_size=2))
