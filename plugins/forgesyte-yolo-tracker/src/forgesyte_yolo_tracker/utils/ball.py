...
class BallAnnotator:
    ...
    def __init__(self, radius: int, buffer_size: int = 5, thickness: int = 2) -> None:
        """
        Initialize BallAnnotator.

        Args:
            radius (int): Maximum radius of the circles to draw.
...
class BallTracker:
    ...
    def __init__(self, buffer_size: int = 10) -> None:
        ...
        Args:
            buffer_size (int): Size of the position history buffer. Defaults to 10.
        """
        self.buffer: deque[np.ndarray] = deque(maxlen=buffer_size)
    ...
    def update(self, detections: sv.Detections) -> sv.Detections:
        ...
        Raises:
            ValueError: If detections array is malformed.
        """
